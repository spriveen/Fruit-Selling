                ...
                <div className='hidden md:block'>
                    <ul className='flex items-center gap-6 text-gray-700'>
                        {NavbarMenu.map((menu) => (
                            <li key={menu.id}>
                                <a href={menu.link}
                                    className='inline-block py-1 px-3 hover:text-red-300 hover:shadow-[0_3px_0_-1px_#ef4444] font-semibold'
                                >
                                    {menu.title}
                                </a>
                            </li>
                        ...
                        <button>
                            <FaShoppingCart className='text-2xl hover:bg-red-800 hover:text-white rounded-2xl p-2 duration-200'/>
                        </button>
                    </ul>
                </div>
